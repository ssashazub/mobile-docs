  ...
  uk: {
    ...
    invoice: {
      ...
      fields: [
        ...
        { key: 'dueDate', label: 'Термін оплати', placeholder: '15.03.2026' },
  ...
  ru: {
    ...
    invoice: {
      ...
      fields: [
        ...
        { key: 'dueDate', label: 'Срок оплаты', placeholder: '15.03.2026' },
  ...
  en: {
    contract: {
      ...
      fields: [
        ...
        { key: 'startDate', label: 'Start date', placeholder: '07.06.2026' },
        { key: 'endDate', label: 'End date', placeholder: '30.06.2026' },
    ...
    invoice: {
      ...
      fields: [
        ...
        { key: 'dueDate', label: 'Payment due date', placeholder: '15.03.2026' },
    ...
    act: {
      ...
      fields: [
        ...
        { key: 'completionDate', label: 'Completion date', placeholder: '10.03.2026' },
        { key: 'amount', label: 'Amount', placeholder: '50,000 UAH' },
